...
function TransactionForm() {
    ...
    return (
        <form action="" onSubmit={handleSubmit}>
            ...
            <input className="bg-zinc-600 text-white rounded-lg px-3 py-2 block mb-2 w-full" type="number" placeholder="0" onChange={(e) => setAmount(e.target.value)} value={amount} />
